...
export enum JS_CMD {
    ...
    AUTOSCALE_TIME_AXIS,
    SET_WHITESPACE_DATA,
    CLEAR_WHITESPACE_DATA,
    UPDATE_WHITESPACE_DATA,
    SET_FRAME_SYMBOL,
    SET_FRAME_TIMEFRAME,
    SET_FRAME_SERIES_TYPE,
    CREATE_INDICATOR,
    REMOVE_INDICATOR,
    ...
    SET_LEGEND_LABEL,
    SET_INDICATOR_MENU,
    SET_INDICATOR_OPTIONS,
    UPDATE_PRICE_SCALE_OPTS,
    UPDATE_IND_PKG,
    POPULATE_IND_PKGS,
    ...
    // Series Markers
    ADD_SERIES_MARKER,
    REMOVE_SERIES_MARKER,
    UPDATE_SERIES_MARKER,
    FILTER_SERIES_MARKERS,
    REMOVE_ALL_SERIES_MARKERS,
    // Series Pricelines
    ADD_SERIES_PRICELINE,
    REMOVE_SERIES_PRICELINE,
    UPDATE_SERIES_PRICELINE,
    FILTER_SERIES_PRICELINES,
    REMOVE_ALL_SERIES_PRICELINES,

    // Primitives
    ADD_PRIMITIVE_SET,
    REMOVE_PRIMITIVE_SET,
    CREATE_PRIMITIVE,
    REMOVE_PRIMITIVE,
    UPDATE_PRIMITIVE_OPTS,
}
